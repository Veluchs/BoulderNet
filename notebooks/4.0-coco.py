...
coco = COCO('/workspaces/BoulderNet/data/coco/innsbruck/annotations/instances.json')
...
# %%
coco.loadImgs(318760886)

# %%
annids = coco.getAnnIds(318760886)
...
# %%
rle_to_bitmap(anns[0]['segmentation'])

# %%
anns[0]['segmentation'].keys()
